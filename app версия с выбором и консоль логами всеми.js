...
console.log('0: shuffle //функция смешивания перетусовывания карт');
...
function cleanCard() {
  ...
  console.log('%cMyProject%cline:296%cbrownAdd', 'color:#fff;background:#ee6f57;padding:3px;border-radius:2px', 
  'color:#fff;background:#1f3c88;padding:3px;border-radius:2px', 
  'color:#fff;background:rgb(254, 67, 101);padding:3px;border-radius:2px', brownAdd)
  ...
  shuffle(randomBrownCards);
   ...
   console.log('%cMyProject%cline:316%crandomBrownCards-розовый', 'color:#fff;background:#ee6f57;padding:3px;border-radius:2px', 'color:#fff;background:#1f3c88;padding:3px;border-radius:2px', 'color:#fff;background:rgb(252, 157, 154);padding:3px;border-radius:2px', randomBrownCards)
    ...
    // let randomRandomBrownCards = JSON.parse(JSON.stringify(randomBrownCards));
    // console.log('%cMyProject%cline:423%crandomRandomBrownCards', 'color:#fff;background:#ee6f57;padding:3px;border-radius:2px', 'color:#fff;background:#1f3c88;padding:3px;border-radius:2px', 'color:#fff;background:rgb(3, 38, 58);padding:3px;border-radius:2px', randomRandomBrownCards)    

    // randomBrownCards = JSON.parse(JSON.stringify(shuffle(randomRandomBrownCards)));
    console.log('%cMyProject%cline:428%crandomBrownCards----после шаффла', 'color:#fff;background:#ee6f57;padding:3px;border-radius:2px', 'color:#fff;background:#1f3c88;padding:3px;border-radius:2px', 'color:#fff;background:rgb(60, 79, 57);padding:3px;border-radius:2px', randomBrownCards)
